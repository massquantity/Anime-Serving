...
import com.mass.serving.mleap.JavaModelServer;
import com.mass.utils.Scala2JavaConverter;
...
public class MLeapJavaModelServing {
    public static void main(String[] args) {
        ...
        JavaModelServer jms = new JavaModelServer("spark/src/main/resources/mleap_model/mleap_model.zip", schema);
